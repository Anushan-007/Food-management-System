...
public class CartFrame extends javax.swing.JFrame {
    ...
    public CartFrame() {
        ...
        // Column widths: ID, Food Name, Unit Price, Quantity, Subtotal
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        for (CartItem cartItem : DataStore.cartItems) {
            if (cartItem.getFoodItem().getFoodId() == selectedFoodId) {
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        int response = JOptionPane.showConfirmDialog(
                this, "Remove this item from the cart?", "Confirm Remove", JOptionPane.YES_NO_OPTION
        );
    ...
    private void btnClearCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearCartActionPerformed
        ...
        int response = JOptionPane.showConfirmDialog(
                this, "Remove all items from the cart?", "Confirm Clear Cart", JOptionPane.YES_NO_OPTION
        );
        if (response == JOptionPane.YES_OPTION) {
    ...
    private void btnConfirmOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmOrderActionPerformed
        ...
        if (customer == null) {
            JOptionPane.showMessageDialog(this, "Please login before confirming the order.", "Login Required", JOptionPane.WARNING_MESSAGE);
        ...
        Order order = new Order(
                DataStore.generateOrderId(), customer, LocalDateTime.now(), orderItems, totalAmount, "Pending"
        );
